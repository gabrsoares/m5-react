...
class App extends React.Component {
  ...
  render() {
      return (
      <div className="App">
        <Display previous={this.state.prevDisplay} atual={this.state.displayNumber} onKeyPress={()=>this.handleKeyPress(this.key)} />
        <div className="buttonList">
          ...
          <Button onClick ={() => this.handleInsertOperation("x")} value ="x"/>
